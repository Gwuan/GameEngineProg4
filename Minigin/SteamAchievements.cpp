...
void CSteamAchievements::Init(Achievement_t *Achievements, int NumAchievements)
{
	...
	m_CallbackUserStatsReceived.Register(this, &CSteamAchievements::OnUserStatsReceived);
	m_CallbackUserStatsStored.Register( this, &CSteamAchievements::OnUserStatsStored );
	m_CallbackAchievementStored.Register( this, &CSteamAchievements::OnAchievementStored );
